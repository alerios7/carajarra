...
mongoose.connect("mongodb://localhost/carajarra_if");
...
passport.serializeUser(Cuenta.serializeUser()); //para logear
passport.deserializeUser(Cuenta.deserializeUser()); //para deslogear
